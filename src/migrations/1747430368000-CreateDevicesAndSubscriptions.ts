...
END$$;
    ...
    await queryRunner.query(
      `ALTER TABLE "push_subscriptions" DROP CONSTRAINT IF EXISTS "UQ_push_subscriptions_device_endpoint"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "push_subscriptions" DROP CONSTRAINT IF EXISTS "FK_push_subscriptions_device"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_subscriptions" DROP CONSTRAINT IF EXISTS "FK_user_subscriptions_program"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "push_subscriptions" ADD COLUMN IF NOT EXISTS "device_id" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "push_subscriptions" ADD CONSTRAINT IF NOT EXISTS "UQ_push_subscriptions_device_endpoint" UNIQUE ("device_id", "endpoint")`,
    );
