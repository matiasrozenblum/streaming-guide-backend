...
describe('BannersService', () => {
  ...
  describe('findAllActive', () => {
    ...
    it('should auto-enable fixed banners when less than 2 banners are active', async () => {
      ...
      // Mock save to return the updated banners array
      ...
      // Should have called save to enable the fixed banners array
    ...
    it('should not auto-enable more than 2 fixed banners', async () => {
      ...
      // Should have called save at most once (for 1 batch auto-enable)
